...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\movies.csv'
	WITH
	(
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\genres.csv'
	WITH
	(
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\actors.csv'
	WITH
	(
	FIRSTROW = 1,
	FIELDTERMINATOR = ',',
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\theaters.csv'
	WITH
	(
	FIRSTROW = 1,
	FIELDTERMINATOR = ',',
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\genretemp.csv'
	WITH
	(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n'
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\moviecast.csv'
	WITH
	(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n'
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\rooms.csv'
	WITH
	(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n'
...
BEGIN
	...
	FROM 'C:\Users\zacha\source\repos\560FinalProject\Excel Files\showtimes.csv'
	WITH
	(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n'
